        ...
        <Sheet>
          ...
          <SheetContent side="bottom" className="h-[80vh]">
            ...
            <div className="space-y-3 mt-4 px-1">
              <div><Label>Material</Label><Input placeholder="e.g. Phi 10 Steel" /></div>
              <div className="grid grid-cols-2 gap-3">
                <div><Label>Quantity</Label><Input type="number" placeholder="200" /></div>
                <div><Label>Unit</Label><Input placeholder="kg" /></div>
              </div>
              <div><Label>Needed by</Label><Input type="date" /></div>
              <div><Label>Reason</Label><Textarea placeholder="Slab pour next Tuesday" /></div>
              <Button className="w-full" onClick={() => toast.success("Shortage request sent to PM")}>Send request</Button>
            </div>
          </SheetContent>
        </Sheet>
